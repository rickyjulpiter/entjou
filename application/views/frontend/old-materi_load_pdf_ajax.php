...
<head>
	...
	<style type="text/css">
        ...
        #topdiv{position: fixed;left: 420px;top: 20px;width: 90px;}
...
<script>    
        var base_url = "<?=base_url('home/coba2')?>";
    	$.ajax({
    	    url: base_url,
    	    success: function(databerkas) {
                ...
                PDFObject.embed(databerkas, viewer, options);
    	    }
    	});
