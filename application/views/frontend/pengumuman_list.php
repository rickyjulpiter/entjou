...
<div class="news-page-area">
    <div class="container">
        <h2 class="title-default-left title-bar-high" align="center">Pengumuman</h2>
        <div class="row">
            <div class="col-lg-9 col-md-9 col-sm-8 col-xs-12">
                <div class="row">
                    <?php 
                    foreach ($data as $key => $value) {
                        $ada = file_exists(realpath(APPPATH . '../assets/images/pengumuman/thumbnail/'.$value['foto']));
                        if(!empty($value['foto']) and $ada){
                            $foto = base_url().'assets/images/pengumuman/thumbnail/'.$value['foto'];
                        }else{
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                        <div class="news-box">
                            ...
                            <div class="konten">
                                <h3 class="title-news-left-bold"><a href="<?=base_url().$value['slug']?>" target="_blank" title="<?=$value['judul']?>">
                                <?php 
                                if (strlen($value['judul'])>=28) {
                                    echo Tools::limit_words($value['judul'],28).'...';
                                }else{
                                    echo $value['judul'];
                                }?>
                                </a></h3>
                                ...
                                <?php 
                                    if (strlen($value['isi'])>=50) {
                                        echo Tools::limit_words(strip_tags($value['isi']),50).' ...';
                                    }else{
                                        echo Tools::limit_words(strip_tags($value['isi']),50);
                                    }
                                ?>
            ...
            <div class="col-lg-3 col-md-3 col-sm-4 col-xs-12">
                <div class="sidebar">
                    ...
                    <div class="sidebar-box">
                        <div class="sidebar-box-inner">
                            <h3 class="sidebar-title">Pengumuman Terakhir</h3>
